...
export type AppViewState = {
  ...
  cronBusy: boolean;
  ccLoading: boolean;
  ccTags: Array<{ name: string; ref_count: number }>;
  ccRefs: Array<{
    id: number;
    type: string;
  ...
  handleLoadCC: () => Promise<void>;
  handleCCQuery: () => Promise<void>;
  handleCCValidate: () => Promise<void>;
  handleCCPrune: () => Promise<void>;
  handleCCDelete: (refId: number) => Promise<void>;
